...
var Feed = (function() {
    ...
    Feed.prototype.createListElement = function(item) {
		...
		var string = this.escape($item.find('description').text());
  srcWithQuotes = string.match(/src\=([^\s]*)\s/)[1],
    imagesrc = srcWithQuotes.substring(6,srcWithQuotes.length - 6);


        return '<li class="feed-item" data-link="' + link + '">' + '<div class="imagediv"><img  src="' + imagesrc  + '" /></div>' + '<div class="text"><h3>' +  title + '</h3><p>' + description + '</p></div></li><div class="clr"></div>';
    };
